...
class ShowUpAnime extends StatefulWidget {
  ...
  @override
  _ShowUpAnimeState createState() => _ShowUpAnimeState();
}

class _ShowUpAnimeState extends State<ShowUpAnime>
  ...
  void initState() {
    ...
    if (_isDisposed) {
      ...
      _animationFade =
          Tween<double>(begin: -2.0, end: 1.0).animate(CurvedAnimation(
        curve: widget.curve,
        parent: _animationController,
      ));
